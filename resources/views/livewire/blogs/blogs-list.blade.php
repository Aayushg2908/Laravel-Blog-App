<div>
    <x-primary-button class="w-full justify-center" x-on:click.prevent="$dispatch('open-modal', 'create-blog')">Create
        Blog</x-primary-button>
            ...
            @foreach ($blogs as $blog)
                <div class="bg-gray-100 shadow-md sm:rounded-lg p-4 mt-4 border">
                    <div class="flex items-center justify-between">
                        <a href="/blog/{{ $blog->id }}" class="text-lg font-medium text-gray-900">
                            {{ $blog->title }}
                        </a>
                            ...
                            <x-dropdown align="left" width="48">
                                <x-slot name="trigger">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        class="lucide lucide-ellipsis-vertical cursor-pointer">
                                ...
                                <x-slot name="content">
                                    <div class="p-1 flex flex-col gap-2">
                                        <div x-on:click.prevent="$dispatch('open-modal', 'edit-blog')"
                                            class="flex items-center gap-x-4 hover:bg-gray-100 p-2 rounded-md"
                                        ...
                                        <div x-on:click.prevent="$dispatch('open-modal', 'delete-blog')"
                                            class="flex items-center gap-x-4 hover:bg-gray-100 p-2 rounded-md"
            ...
            <div class="mt-6 space-y-6">
                <div>
                    ...
                    <x-text-input wire:model="title" id="title" name="title" type="text"
                        class="mt-1 block w-3/4" placeholder="{{ __('Title') }}" />
